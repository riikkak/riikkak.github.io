...
published: true
---
## Tervetuloa ruotsin toiselle kurssille! Tällä kurssilla opettelemme kertomaan ruotsiksi seuraavista teemoista:

1. ruoka ja ravintolassa käynti
2. vaatteet ja ostaminen
3. kroppa ja hyvinvointi
4. Norja
5. ystävyys
...
2. Sivulause (alistuskonjunktio)
3. Lukusanat
4. Käskymuoto
5. Adjektiivin vertailu
...
- Pakolliset sivut on oltava tehtyinä arviointipäivään mennessä (muista huolehtia täytetyiksi poissaolojen ajalta!)
...
Kaksi aihetta kurssin teemoista, sisältää mahdollisesti myös ääntämisosuuden. Toinen pakollinen, toinen extra.
...
- Kaksi pakollista ohjattua kirjoitustehtävää (40p).
- 1-3 vapaaehtoista (palautus ennen arviointipäivää)
- Kirjoitetaan Emendedissä, apuna kirja ja työvihko, EI muita apuja.
